...
<body id="page-top">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-status-normal">Normal
                                                <i class="fas fa-circle fa-1x icon-alarm-off"></i>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <button id="btn_isolate" class="btn btn-warning btn-icon-split mt-4" style="width: -webkit-fill-available;">
                                            <span class="text"><i class="fas fa-exclamation-triangle"></i> Isolate</span>
                                        </button>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        $("btn_isolate").click(function(){
            $.ajax({url: "/ifastv2/ack.php", success: function(result){
                //$("#div1").html(result);
                console.log(result);
            }});
        });
